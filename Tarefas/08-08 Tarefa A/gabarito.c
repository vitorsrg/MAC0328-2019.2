...
//
// 0. Mude o nome deste arquivo.
// 1. Escreva um comentário no início para dizer O QUE o programa faz.
// 2. Antes de cada função, escreva um comentário explicando O QUE a
//    função faz.
// 3. Não escreva nenhum outro comentário (a menos que ele seja
